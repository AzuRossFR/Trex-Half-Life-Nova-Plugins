...
SWEP.Instructions = [[Clique gauche pour immobilisé une cible]]

SWEP.Category = "TrexStudio | SWEP"
...
SWEP.ViewModel = Model( "models/sterling/c_enhanced_taser.mdl" )
...
if( CLIENT ) then
	language.Add( "stungun_ammo", "Cartouches de Tazer" )
end
	...
	if( tr.Entity and IsValid( tr.Entity ) and tr.Entity:IsPlayer() and not tr.Entity:GetNWBool( "BES_TASERED", false ) and tr.Entity:GetPos():DistToSqr( self:GetPos() ) < 60000 ) then
			...
			if SERVER then
				...
				timer.Simple( 1, function()
					tr.Entity:EmitSound( "vo/npc/male01/pain06.wav" )
				end)
				timer.Simple( 2, function()
					tr.Entity:EmitSound( "vo/npc/male01/pain04.wav" )
				end)
				timer.Simple( 3, function()
					tr.Entity:EmitSound( "vo/npc/male01/pain05.wav" )
				end)
				timer.Simple( 4, function()
					tr.Entity:EmitSound( "vo/npc/male01/pain03.wav" )
				end)
				...
				timer.Simple( 5, function()
					if( tr.Entity and IsValid( tr.Entity ) and tr.Entity:IsPlayer() and tr.Entity:GetNWBool( "BES_TASERED", false ) ) then
						...
						tr.Entity:EmitSound( "vo/npc/male01/pain02.wav" )
					end
				end )
			end
