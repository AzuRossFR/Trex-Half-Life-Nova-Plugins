ENT.Type = "anim"
ENT.PrintName = "Stockage Premium"
ENT.Category = "Helix"
ENT.Spawnable = true
ENT.AdminOnly = true
ENT.bNoPersist = true
...
if (SERVER) then
	...
	function ENT:Use(activator)
		...
		if (!CAMI.PlayerHasAccess(activator, "Helix - SafeBox", nil)) then
			return ix.util.Notify("Vous n'êtes pas Premium !", activator)
		end
		...
		ix.safebox.Restore(activator, function()
			if (openTime > 0) then
				activator:SetAction("Ouverture...", openTime)
	...
	function ENT:OnPopulateEntityInfo(tooltip)
		...
		description:SetText("Peut contenir des objets en permanence.")
