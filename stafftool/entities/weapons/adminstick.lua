...
SWEP.Purpose = "Instructions:Appuyez sur R lorsque vous regardez quelqu'un pour le sélectionner. \nAppuyez sur Maj+R pour vous sélectionner. \nClic gauche pour ouvrir le menu. \nCliquez droit avec la sélection pour les figer."
...
function SWEP:SecondaryAttack()
    ...
    if MascoStick.StickTarget:IsPlayer() and MascoStick.StickTarget != LocalPlayer() then
        ...
        LocalPlayer():Notify("Vous ne pouvez pas freeze ce que vous regardez. Veuillez réessayer.")
    end
end
...
function SWEP:DrawHUD()
    ...
    if MascoStick.StickTarget:IsPlayer() then
        ...
        MascoStick.StickTarget.Information = {
            IsValid(LocalPlayer().AdminStickTarget) and "Joueur (sélectionné avec rechargement)" or "Joueur", "Surnom: " .. MascoStick.StickTarget:Nick(), "Nom Steam: " .. (MascoStick.StickTarget.SteamName and MascoStick.StickTarget:SteamName() or MascoStick.StickTarget:Name()), "Steam ID: " .. MascoStick.StickTarget:SteamID(), "Vie: " .. MascoStick.StickTarget:Health(), "Armure: " .. MascoStick.StickTarget:Armor(), "Rang: " .. MascoStick.StickTarget:GetUserGroup()
        }
        ...
        if MascoStick.StickTarget:GetCharacter() then
            ...
            table.Add(MascoStick.StickTarget.Information, {"Nom du personnage: " .. MascoStick.StickTarget.Character:GetName(), "Faction du personnage: " .. MascoStick.StickTarget.Faction.uniqueID .. " (" .. MascoStick.StickTarget.Faction.name .. ")"})
        else
            table.insert(MascoStick.StickTarget.Information, "Aucun personnage chargé")
        end
    elseif MascoStick.StickTarget:IsWorld() then
        ...
        MascoStick.StickTarget.Information = {"Entité", "Class: " .. MascoStick.StickTarget:GetClass(), "Model: " .. MascoStick.StickTarget:GetModel(), "Position: " .. tostring(MascoStick.StickTarget:GetPos()), "Angles: " .. tostring(MascoStick.StickTarget:GetAngles()), "Owner: " .. tostring(MascoStick.StickTarget:GetNWString("Creator_Nick", "NULL")), "EntityID: " .. MascoStick.StickTarget:EntIndex()}
