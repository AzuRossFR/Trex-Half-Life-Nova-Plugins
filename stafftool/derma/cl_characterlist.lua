net.Receive("MascoStick::SendCharacterList", function(len, ply)
    ...
    MascoStick.CharacterFrame.Paint = function(self, w, h)
        ...
        draw.DrawText("Liste des personnages", "CharacterListTitle", w * 0.5, 8, color_white, TEXT_ALIGN_CENTER)
    end
    ...
    MascoStick.CharacterFrame.CharListView:AddColumn("Argent")
    MascoStick.CharacterFrame.CharListView:AddColumn("Banni?")
    ...
    MascoStick.CharacterFrame.CharListView.DoDoubleClick = function(ListView, LineID, Line)
        if Line.CharacterID then
            ...
            MascoStick.CharacterList.DMenu.Option1 = MascoStick.CharacterList.DMenu:AddOption("Bannnir le personnage", function()
            ...
            MascoStick.CharacterList.DMenu.Option2 = MascoStick.CharacterList.DMenu:AddOption("Dé-Bannir le personnage", function()
