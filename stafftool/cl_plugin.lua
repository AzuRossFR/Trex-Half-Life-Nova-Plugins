function MascoStick.OpenPlayerModelUI(target)
    ...
    MascoStick.PMFrame:SetTitle("Changer le Model")
    ...
    MascoStick.PMFrame.Button:SetText("Changer")
...
function MascoStick.OpenReasonUI(target, cmd, time)
    ...
    MascoStick.ReasonFrame:SetTitle("Raison pour " .. cmd)
    ...
    MascoStick.ReasonFrame.Edit:SetPlaceholderText("Raison")

    if (cmd == "banid") then
        MascoStick.ReasonFrame.Time = MascoStick.ReasonFrame:Add("DNumSlider")
        MascoStick.ReasonFrame.Time:Dock(TOP)
        MascoStick.ReasonFrame.Time:SetText("Longeur (jour)")
    ...
    MascoStick.ReasonFrame.Button:SetText("Changer")

    function MascoStick.ReasonFrame.Button:DoClick()
        MascoStick.ReasonFrame.Button.Text = MascoStick.ReasonFrame.Edit:GetValue()

        if cmd == "banid" then
            MascoStick.ReasonFrame.BanTime = MascoStick.ReasonFrame.Time.Edit:GetValue() * 60 * 24
            RunConsoleCommand("sam", cmd, target:SteamID(), MascoStick.ReasonFrame.BanTime, MascoStick.ReasonFrame.Button.Text)
        else
...
function MascoStick.OpenAdminStickUI(isright, target)
    ...
    if target:IsPlayer() then
        MascoStick.AdminMenu.Name = MascoStick.AdminMenu:AddOption("Nom: " .. target:Name() .. " (clique gauche pour copier)", function()
            LocalPlayer():ChatPrint("Le nom : " .. target:Name() .. " est copié au presse papier !")
        ...
        MascoStick.AdminMenu.CharID = MascoStick.AdminMenu:AddOption("CharID: " .. target:GetCharacter():GetID() .. " (left click to copy)", function()
            LocalPlayer():ChatPrint("Le CharID: " .. target:GetCharacter():GetID() .. " est copié au presse papier!")
        ...
        MascoStick.AdminMenu.SteamID = MascoStick.AdminMenu:AddOption("SteamID: " .. target:SteamID() .. " (clique gauche pour copier)", function()
            LocalPlayer():ChatPrint("Le SteamID: " .. target:SteamID() .. " est copié au presse papier!")
        ...
        MascoStick.AdminMenu.SteamID64 = MascoStick.AdminMenu:AddOption("SteamID64: " .. target:SteamID64() .. " (clique gauche pour copier)", function()
            LocalPlayer():ChatPrint("Le SteamID64: " .. target:SteamID64() .. " est copié au presse papier!")
        ...
        if target:IsFrozen() then
            ...
            MascoStick.AdminMenu.PlayerInfo.Freeze = MascoStick.AdminMenu.PlayerInfo:AddOption("Freeze", function()
                if LocalPlayer() == target then
                    ix.util.Notify("Vous ne pouvez pas vous freez. Veuillez réessayer.")
        ...
        MascoStick.AdminMenu.CharacterInfo = MascoStick.AdminMenu:AddSubMenu("Personnages")

        MascoStick.AdminMenu.CharacterInfo.CharList = MascoStick.AdminMenu.CharacterInfo:AddOption("Afficher tous les personnages", function()
        ...
        MascoStick.AdminMenu.CharacterInfo.Inventory = MascoStick.AdminMenu.CharacterInfo:AddOption("Rechercher dans l'inventaire", function()
        ...
        MascoStick.AdminMenu.CharacterInfo.ChangeName = MascoStick.AdminMenu.CharacterInfo:AddOption("Changer le Nom", function()
        ...
        MascoStick.AdminMenu.CharacterInfo.ChangeModel = MascoStick.AdminMenu.CharacterInfo:AddOption("Change le Playermodel", function()
            MascoStick.OpenPlayerModelUI(target)
        end)

        MascoStick.AdminMenu.CharacterInfo.ChangeModel:SetIcon("icon16/user_suit.png")

        MascoStick.AdminMenu.CharacterInfo.CharPK = MascoStick.AdminMenu.CharacterInfo:AddOption("PK Personnage", function()
        ...
        MascoStick.AdminMenu.CharacterInfo.CharKick = MascoStick.AdminMenu.CharacterInfo:AddOption("Kick Personnage", function()
        ...
        for _, Faction in SortedPairs(ix.faction.teams) do
            if Faction.index == target:GetCharacter():GetFaction() then
                MascoStick.AdminMenu.CharacterInfo.Faction = MascoStick.AdminMenu.CharacterInfo:AddSubMenu("Set la Faction (" .. Faction.name .. ")")
        ...
        MascoStick.AdminMenu.CharacterInfo.Whitelist = MascoStick.AdminMenu.CharacterInfo:AddSubMenu("Donner une Whitelist de Faction")
        ...
        MascoStick.AdminMenu.CharacterInfo.RemoveWhitelist = MascoStick.AdminMenu.CharacterInfo:AddSubMenu("Révouer une Whitelist de Faction")
        ...
        MascoStick.AdminMenu.SAMFunctions.GoTo = MascoStick.AdminMenu.SAMFunctions:AddOption("GoTo", function()
    ...
    elseif target:IsDoor() then
        ...
        MascoStick.AdminMenu.Door.Title = MascoStick.AdminMenu:AddOption("Définir le titre de la porte", function()
        ...
        if target:GetNetVar("title") != nil or target:GetNetVar("name") != nil then
            MascoStick.AdminMenu.Door.RemoveTitle = MascoStick.AdminMenu:AddOption("Supprimer le titre de la porte", function()
        ...
        if target:GetNetVar("visible") == true then
            MascoStick.AdminMenu.Door.Hide = MascoStick.AdminMenu:AddOption("Rendre la porte cachée", function()
        ...
        elseif target:GetNetVar("visible") == nil or target:GetNetVar("visible") == false then
            MascoStick.AdminMenu.Door.Visible = MascoStick.AdminMenu:AddOption("Rendre la porte visible", function()
        ...
        if target:GetNetVar("ownable") == nil then
            MascoStick.AdminMenu.Door.Ownable = MascoStick.AdminMenu:AddOption("Rendre la porte propriétaire", function()
        ...
        elseif target:GetNetVar("ownable") == true then
            MascoStick.AdminMenu.Door.Unownable = MascoStick.AdminMenu:AddOption("Rendre la porte impossible à posséder", function()
        ...
        MascoStick.AdminMenu.AddFaction = MascoStick.AdminMenu:AddSubMenu("Ajouter une faction à la porte")
        ...
        if target:GetNetVar("faction") != nil then
            MascoStick.AdminMenu.RemoveFaction = MascoStick.AdminMenu:AddSubMenu("Supprimer la faction de la porte")
            ...
            MascoStick.AdminMenu.RemoveFaction.ClearAll = MascoStick.AdminMenu:AddOption("Effacer les factions de la porte", function()
                LocalPlayer():ConCommand('say /DoorSetFaction ')
                MascoStick.IsOpen = false
            end)
        end
