...
function PANEL:PopulateInfo()
  ...
  self.CurrentStatus:SetText("Votre état civil actuel: " .. status)
  self.CurrentStatus:SetTextColor(statcol)
  self.CurrentStatus:SizeToContents()


  self.CitizenID:SetText("Votre CID actuel: " .. CID)
  self.CitizenID:SizeToContents()


  self.Wallet:SetText("Votre nombre actuel de jetons est de: " .. LocalPlayer():GetCharacter():GetMoney())
  self.Wallet:SizeToContents()


  self.Employment:SetText("Votre emploi actuel est: " .. team.GetName(LocalPlayer():Team()))
  self.Employment:SizeToContents()


  self.Violation:SetText("Vos points d'infraction actuels sont: " .. LocalPlayer():GetCharacter():GetData("vp", "N/A"))
  self.Violation:SizeToContents()


  self.Loyalty:SetText("Vos points de fidélité actuels sont: " .. LocalPlayer():GetCharacter():GetData("lp", "N/A"))
