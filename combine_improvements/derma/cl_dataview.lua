...
function PANEL:PopulateInfo(civ, civRecord, civPoints)
  ...
  self.TotalPoints:AppendText("Ce citoyen possède: ")
  ...
  if totalPoints >= 0 then
    ...
    self.TotalPoints:AppendText(totalPoints .. " Points de crédits sociaux")
  else
  ...
  self.list.OnRowSelected = function(lst, index, record)
    self.viewInfo.DoClick = function()
      ...
      RecordView:SetTitle("Enregistrement")
      ...
      RecordContents:AppendText("Motif de l'enregistrement: " .. reason .. "\n \n")
