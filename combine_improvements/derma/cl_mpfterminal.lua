...
function PANEL:Init()
  ...
  self.SetStatus:SetText("Définir le statut du citoyen")

  self.SetCID = vgui.Create("DButton", self)
  self.SetCID:SetSize(100, 25)
  self.SetCID:SetPos(575, 450)
  self.SetCID:SetText("Définir le CID du citoyen")
...
function PANEL:PopulateCitizens()
  ...
  self.CitizenList.OnRowSelected = function(lst, index, row)
    ...
    self.Record.DoClick = function()
      ...
      TextFrame:Center()
      TextFrame:MakePopup()
      TextFrame:SetTitle("Historique des enregistrements")
      ...
      net.Receive("RecordRequest", function()
        ...
        TotalPoints:AppendText("Ce citoyen possède: ")

        if totalPoints >= 0 then
          TotalPoints:InsertColorChange(0, 255, 0, 255)
          TotalPoints:AppendText(totalPoints .. " Points de crédits sociaux")
        else
      ...
      RemoveRecord:SetText("Retirer Enregistrement")
      ...
      AddRecord:SetText("Rajouter un enregistrement")
      ...
      RecordList.OnRowSelected = function(list, ind, record)
        ...
        ViewRecord.DoClick = function()
          ...
          if type == "Violation" then
            ...
            RecordContents:AppendText("Type d'enregistrement: " .. type .. "\n \n")
          ...
          RecordContents:AppendText("Raisons de l'enregistrement: " .. reason .. "\n \n")
    ...
    self.PrintCID.DoClick = function()
      ...
      LocalPlayer():Notify("Vous avez imprimé un nouveau CID pour " .. SelectName)
