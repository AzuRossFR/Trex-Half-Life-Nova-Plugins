...
local logotype = ix.util.GetMaterial("trex/ui/logohln.png","noclamp smooth")
...
local icons = {
	...
	ix.util.GetMaterial("trex/icon24.png"),
...
function PANEL:Init()
	...
	self.addpaint.Paint = function(this, w, h)
		...
		surface.SetMaterial(logotype)
			...
			surface.DrawTexturedRect(ScrW() / 70, ScrH() / 6, ScrW() - ScrW()/2.6, ScrH() - ScrH()/1.33)
	...
	self.loadbutton:SetText(('PERSONNAGES'):utf8upper())
	...
	discord:SetMaterial(ix.util.GetMaterial("trex/discord.png"))
