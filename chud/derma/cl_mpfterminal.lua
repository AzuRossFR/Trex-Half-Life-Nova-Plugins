...
function PANEL:Init()
  ...
  function dock.text:SetInfo( ent, notes )
    ...
    self:AppendText( "Crédits civils: " .. points .. "\n\n" )
    ...
    self:AppendText( "État de la réponse: " .. bol .. "\n\n\n" )
  ...
  dock.record:SetText( "Voir la fiche" )
  ...
  local function nRecordRequest()
    ...
    panel:Center()
    panel:MakePopup()
    panel:SetTitle( ent:GetName() .. "Fiche de l'intéressé(e)" )
    ...
    list:AddColumn( "Type d'enregistrement" ):SetFixedWidth( pW/8 )
    list:AddColumn( "Points" ):SetFixedWidth( pW/16 )
    list:AddColumn( "Raison" )
    ...
    addRecord:SetText( "Ajouter un enregistrement" )
    ...
    function addRecord:DoClick()
      ...
      frame:MakePopup()
      frame:Center()
      frame:SetTitle( "Ajouter un enregistrement" )
      ...
      function info:Paint( w, h )
        ...
        surface.DrawRect( 0, 0, w, h )
        draw.SimpleText( "Détails de l'enregistrement d'entrée", "Trebuchet24", 5, h/2, Color( 255, 255, 255 ), nil, TEXT_ALIGN_CENTER )
      end
      ...
      finish:SetText( "Ajouter un enregistrement" )
      finish:Dock( BOTTOM )
      ...
      type:Dock( BOTTOM )
      type:AddChoice( "Loyauté" )
      type:AddChoice( "Violation" )
      type:SetValue( "Sélectionner le type d'enregistrement" )
      ...
      function finish.DoClick()
        ...
        if ( sPoints < 0 ) then
          LocalPlayer():Notify( "Vous ne pouvez pas utiliser un nombre négatif de points, définissez plutôt un type d'enregistrement.")
          return
        end
    ...
    removeRecord:SetText( "Supprimer un enregistrement" )
    ...
    viewRecord:SetText( "Voir les détails" )
    ...
    function viewRecord:DoClick()
      ...
      view:MakePopup()
      view:Center()
      view:SetTitle( "Détails de l'enregistrement" )
      ...
      if ( details.type == "Fidélité" ) then
        data:InsertColorChange( 0, 220, 0, 255 )
      else
        data:InsertColorChange( 220, 0, 0, 255 )
      end
      data:AppendText( "Type d'enregistrement: " .. details.type .. "\n\n" )
  ...
  dock.notes:SetText( "Modifier les notes" )
  ...
  function dock.notes:DoClick()
    ...
    local frame = vgui.Create( "DFrame" )
    frame:SetTitle( "Modifier les notes" )
    ...
    button:SetText( "Ajouter des notes" )
  ...
  dock.setBOL:SetText( "Définir l'état de la réponse" )
