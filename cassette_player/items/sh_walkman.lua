ITEM.name = "Radio cassette"
ITEM.description = "Un lecteur de cassettes portable."
...
function ITEM:GetDescription()
    ...
    if self:GetData("CurTape", nil) == nil then
        str = str.." \n\nBande insérée : Aucune."
    else
        str = str.." \n\nBande insérée: "..ix.item.list[self:GetData("CurTape", nil)].name.."."
    end
