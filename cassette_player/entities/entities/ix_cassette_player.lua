...
if (SERVER) then
	function ENT:Initialize()
		self:SetModel("models/fruity/tablet/tablet_sfm.mdl")
	...
	function ENT:OnPopulateEntityInfo(container)
		...
		name:SetImportant()
		name:SetText("Dispositif d'écoute : Combine")
		name:SizeToContents()
		local descriptionText = self:GetNetVar("Description", "Permet d'écouter des enregistrements..")
