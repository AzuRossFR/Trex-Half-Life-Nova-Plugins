...
do
	...
	CHANNEL.icon = ix.util.GetMaterial("trexhln/chat/cp_radio_icon.png")
	CHANNEL:Register()

	-- cp main
	CHANNEL = ix.radio:New()
	CHANNEL.name = "RADIO TC"
	CHANNEL.uniqueID = "tc_main"
	CHANNEL.subChannels = 1
	CHANNEL.global = false
	CHANNEL.defaultPriority = 10
	CHANNEL.stationaryCanAccess = false
	CHANNEL.color = Color(50, 180, 215, 255)
	CHANNEL.icon = ix.util.GetMaterial("trexhln/chat/broadcast_icon.png")
	CHANNEL:Register()
	...
	CHANNEL.icon = ix.util.GetMaterial("trexhln/chat/dispatch_icon.png")
	CHANNEL:Register()
