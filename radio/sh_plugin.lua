...
function PLUGIN:InitializedChatClasses()
	local iconDefault = ix.util.GetMaterial("nova/chat/radio_hand.png")

	ix.chat.Register("radio", {
		color = Color(75, 150, 50),
		format = "[%s] %s %s sur la radio \"%s\"",
		bReceiveVoices = true,
	...
	ix.chat.Register("radio_eavesdrop", {
		...
		OnChatAdd = function(class, speaker, text, bAnonymous, data)
			...
			chat.AddText(class.color, ix.util.GetMaterial("nova/chat/eaves_radiohand.png"), string.format(class.format,
