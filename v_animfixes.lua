...
ix.anim.SetModelClass("models/minecraft/steve/steve.mdl", "player")
ix.anim.SetModelClass("models/ludex/mmod_tactical/pmc_gordon/pmc_gordon_freeman_pm.mdl", "player")
