...
function PANEL:Init()
	...
	self.description:SetFont("CHud3")
...
function PANEL:SetPlayer(client)
	...
	self.staff = client:GetUserGroup()
...
function PANEL:Paint(width, height)
    ...
    draw.RoundedBoxEx(8, 0, 0, width, height, ColorAlpha(faction.color, 50), false, false, false, false)
	surface.SetDrawColor(faction.color)
	surface.SetTexture(gradl)
	surface.DrawTexturedRect(0,0,width, 30)
   -- draw.RoundedBoxEx(8, 0, 0, width, 30, faction.color, false, false, false, false)
...
hook.Add("CreateMenuButtons", "ixScoreboard", function(tabs)
	...
	Create = function(info, container)
		...
		container:DockPadding(0,32,0,0)
	end
}
end)
