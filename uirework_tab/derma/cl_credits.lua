...
local SPECIALS = {
	...
	},
	{
		...
		{"Veeds", "76561198192574995"}
	}
}

local MISC = {
	{"Nebulous", "Les membres du personnel pour avoir trouver des bugs et fournis des commentaires."},
	{"Contributors", "Support continu de divers développeurs via GitHub"},
	{"NutScript", "Fournisseur du framework de base sur lequel s’appuyer pour Helix"}
}
...
function PANEL:Paint(width, height)
	derma.SkinFunc("DrawHelixCurved", width * 0.5, height * 0.5, width * 0.18)

	-- title
	surface.SetFont("CHud")
	local text = L("helix"):upper()
...
hook.Add("PopulateHelpMenu", "ixCredits", function(tabs)
	tabs["crédits"] = function(container)
